                        ...
                        <ul class="navbar-nav m-auto">
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="index-two.php" class="nav-link">Home Two</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="index-three.php" class="nav-link">Home Three</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="index-four.php" class="nav-link">Home Four</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="index-five.php" class="nav-link">Home Five</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="candidate-details.php" class="nav-link">Candidates Details</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="blog-two.php" class="nav-link active">Blog Two</a>
                                    </li>
                                    <li class="nav-item">
                    ...
                    <div class="blog-widget">
                        ...
                        <article class="popular-post">
                            ...
                            <div class="info">
                                ...
                                <h4>
                                    <a href="blog-details.php">Looking for Highly Motivated Product to Build</a>
                                </h4>
                            </div>
                        </article>
